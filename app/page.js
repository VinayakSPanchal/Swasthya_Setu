        ...
        <div className="container mx-auto px-4">
          ...
          <Pricing/>
            {/* <Card className="bg-card border-emerald-900/20">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">$10 / session</p>
            ...
            {/* <Card className="bg-card border-emerald-900/20">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">$25 / month</p>
                <p className="text-sm text-muted-foreground">
            ...
            {/* <Card className="bg-card border-emerald-900/20">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">$50 / month</p>
                <p className="text-sm text-muted-foreground">
